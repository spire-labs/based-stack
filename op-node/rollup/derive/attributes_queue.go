...
type AttributesBuilder interface {
	PreparePayloadAttributes(ctx context.Context, l2Parent eth.L2BlockRef, epoch eth.BlockID, electionWinner common.Address) (attrs *eth.PayloadAttributes, err error)
}
...
func (aq *AttributesQueue) NextAttributes(ctx context.Context, parent eth.L2BlockRef, electionWinner common.Address) (*AttributesWithParent, error) {
...
func (aq *AttributesQueue) createNextAttributes(ctx context.Context, batch *SingularBatch, l2SafeHead eth.L2BlockRef, electionWinner common.Address) (*eth.PayloadAttributes, error) {
