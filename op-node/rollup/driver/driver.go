...
type DerivationPipeline interface {
	Reset()
	Step(ctx context.Context, pendingSafeHead eth.L2BlockRef, electionWinner common.Address, preOriginTime uint64, winnerTime uint64) (*derive.AttributesWithParent, error)
